...
{
    public partial class ListeCoursier : System.Web.UI.Page
    {
        ...
        public DataTable convertToDataTable()
        {
            ...
            List<User> userList = new List<User>(UF.GetAllCoursiers());
        ...
        protected void delCoursier_OnClick(object sender, EventArgs e)
        {
            string cnnStr = ConfigurationManager.ConnectionStrings["cnn1"].ConnectionString;
            UserFactory UF = new UserFactory(cnnStr);

            UF.falseDeleteUser(Convert.ToInt32(((LinkButton)sender).CommandArgument.ToString()));
            Response.Redirect("ListeCoursier.aspx");
